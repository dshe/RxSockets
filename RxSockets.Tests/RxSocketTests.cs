...
namespace RxSockets.Tests
{
    public class RxSocketClientTest : TestBase, IAsyncLifetime
    {
        ...
        public RxSocketClientTest(ITestOutputHelper output) : base(output) =>
            Server = IPEndPoint.CreateRxSocketServer(10, SocketServerLogger);
        ...
        public async Task T00_Cancel()
        {
            await Assert.ThrowsAsync<OperationCanceledException>(async () =>
                await IPEndPoint.ConnectRxSocketClientAsync(10, SocketClientLogger, ct:new CancellationToken(true)));
        }
